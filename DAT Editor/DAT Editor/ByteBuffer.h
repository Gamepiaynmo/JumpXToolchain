...
namespace bb {
	...
	public:
		...
		QString getStringLength() const;
		int32_t getCompressedInt() const;
		...
		void putChars(const char* b, uint32_t len);
		...
		void putStringLength(QString value);
		void putCompressedInt(int64_t value);
